...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="index site-header" role="banner" style="background: url(<?php echo $src[0] ?>) 50% 50% / cover no-repeat;">
	<?php else: ?>
	<header id="masthead" class="index site-header" role="banner" style="background: url(<?php header_image(); ?>) 50% 50% / cover no-repeat;">
	<?php endif; ?>	
		...
		<?php if ($headerOverlay == 1 ) : ?>
			<div class="index site-brand-main" style=" background-image: url(<?php echo get_template_directory_uri() . '/images/overlay.png'; ?>);">
		<?php else: ?>
			<div class="index site-brand-main">
		<?php endif; ?>
			<div class="site-branding">
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="/wordpress-gk/wp-content/themes/fortunato-child/images/gk_logo.png"></a></h1>
